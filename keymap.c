...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
   * |  Tab/L2|   Q  |   W  |   E  |   R  |   T  | ~L3  |           | ~L3  |   Y  |   U  |   I  |   O  |   p  |   å    |
   * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
  ...
  [BASE] = KEYMAP(  // layer 0 : default
                  ...
                  LT(MDIA, KC_TAB),         KC_Q,         KC_W,    KC_E,    KC_R,    KC_T,   MO(SPEC),
                  ...
                  MEH_T(KC_NO), KC_N,    KC_M,    KC_COMM, KC_DOT,            CTL_T(KC_SLSH),   LSFT_T(KC_BSLS),
   ...
   * |        |  F1  |  F2  |  F3  |  F4  |  F5  |      |           |      |  F6  |  F7  |  F8  |  F9  | F10  |  F11   |
   * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
   * |        |      | Lclk | MsUp | Rclk |ScrlUp|      |           | PLAY |      |      |      |      |      |  F12   |
   * |--------+------+------+------+------+------|      |           | PAUSE|------+------+------+------+------+--------|
   * |        | Mclk |MsLeft|MsDown|MsRght|ScrlDn|------|           |------| LEFT | DOWN |  UP  | RIGHT|      | VOLUP  |
   * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
   * |        |      |      |      |      |      |      |           |      |      |      |      |      |      | VOLDWN |
   * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
   *   |      |      |      |      |      |                                       |      |      | MPREV| MNEXT| MUTE |
  ...
  [MDIA] = KEYMAP(
                  ...
                  // right hand
                  KC_TRNS,  KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,
                  KC_MPLY, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_F12,
                           KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_TRNS, KC_VOLU,
                  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_VOLD,
                                    KC_TRNS, KC_TRNS, KC_MPRV, KC_MNXT, KC_MUTE,
                  KC_TRNS, KC_TRNS,
                  KC_TRNS,
